function getMovieCover(movie, like_count) {
	...
	$.getJSON(url, function(data) {
		...
		output(movie, image, like_count);
	});
};

function getMusic(artist, like_count) {
	...
	$.getJSON(url, function(data) {
		...
		if (obj.artistmatches.artist == undefined) {
			...
			var image = tmp['#text'];
			output(artist, image, like_count);
		}
		;
	});
};

function getBookCover(book, like_count) {
